...
with open("input/data/report_data.json", "r", encoding="utf-8") as f:
    report_data = json.load(f)

with open("input/data/style.json", "r", encoding="utf-8") as f:
...
with open("output/audit_report_without_measures.pdf", "wb") as f:
    f.write(pdf)
